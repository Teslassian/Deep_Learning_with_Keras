...
def plot_decision_boundary(model, X, y):
    ...
    # make a prediction with the model and reshape the output so that contourf can plot it
    c = model.predict(ab)
...
i = Input(shape=(2,))
x = Dense(4, activation='tanh', name='Hidden-1')(i)
...
# Fit the model with the data from make_blobs.
...
# Get kiss abd accuracy on test data
